...
class Predictive_Services_Areas_Perspective:
    ...
    def plot_SPC_extended_dry_lightning_outlook(directory_name, western_bound, eastern_bound, southern_bound, northern_bound, central_longitude, central_latitude, first_standard_parallel, second_standard_parallel, fig_x_length, fig_y_length, signature_x_position, signature_y_position, key_x_position, key_y_position, subplot_title_fontsize, signature_fontsize, key_fontsize, show_rivers):
        ...
        if files == 5:
            ...
            fig4.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
        ...
        if files >= 6:
            ...
            fig5.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
    ...
    def plot_SPC_extended_critical_fire_weather_risk_outlook(directory_name, western_bound, eastern_bound, southern_bound, northern_bound, central_longitude, central_latitude, first_standard_parallel, second_standard_parallel, fig_x_length, fig_y_length, signature_x_position, signature_y_position, key_x_position, key_y_position, subplot_title_fontsize, signature_fontsize, key_fontsize, show_rivers):
        ...
        if files == 4:
            ...
            fig.set_facecolor('aliceblue')
            fig.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
            ...
            fig1.set_facecolor('aliceblue')
            fig1.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig1.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
            ...
            fig2.set_facecolor('aliceblue')
            fig2.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig2.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
            ...
            fig3.set_facecolor('aliceblue')
            fig3.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig3.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
        ...
        if files == 5:
            ...
            fig4.set_facecolor('aliceblue')
            fig4.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig4.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
        ...
        if files >= 6:
            ...
            fig5.set_facecolor('aliceblue')
            fig5.text(signature_x_position, signature_y_position, 'Plot Created With FireWxPy (C) Eric J. Drewitz 2023 | Data Source: NOAA/NWS/SPC\nImage Created: ' + utc_time.strftime('%m/%d/%Y %H:%MZ'), fontsize=signature_fontsize, fontweight='bold')
            fig5.text(key_x_position, key_y_position, 'Red Areas = 70% probability of the following:\n1) Strong winds\n2) Low relative humidity\n3) Warm temperatures\nLasting at least 3 hours with dry fuels', fontsize=key_fontsize, fontweight='bold')
