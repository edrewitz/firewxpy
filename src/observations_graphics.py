...
def graphical_daily_summary(station_id):
    ...
    fig.text(0.025, 0.02, "Plot Created With FireWxPy (C) Eric J. Drewitz 2024 | Data Source: thredds.ucar.edu\n                                Image Created: " + local_time.strftime('%m/%d/%Y %H:%M Local') + " (" + utc_time.strftime('%H:%M UTC')+")", color='white', fontsize=17, fontweight='bold')
