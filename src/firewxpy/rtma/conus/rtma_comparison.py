"""
This file hosts the functions for the CONUS Real Time Mesoscale Analysis (RTMA) Comparison Graphics
...
These functions plot the Real Time Mesoscale Analysis Comparison for CONUS.
...
- region (String) - Default='conus'. The region of the plot. Use the 2-letter state abbreviation or 4-letter GACC abbreviation.
...
- colormap (String) - The Matplotlib colormap for filled contours being used OR set to 'custom' to create your own 
...
- colors (String List) - Example (Temperature Change Custom Colormap): colors=['purple',
                                                                                'darkblue',
                                                                                'dodgerblue',
                                                                                'white',
                                                                                'crimson',
...
- current_barb_length (Float or Integer) - Default=4. Length of the wind barb for the current time.
    
- current_barb_width (Float or Integer) - Default=0.5. Width of the wind barb for the current time.
    
- current_barb_color (String) - Default='gray'. Color of the wind barb for the current time.
    
- current_barb_zorder (Integer) - Default=7. The z-order of the barbs on the image. Lower numbers send this to the back
        higher numbers bring this forward.
    
- comparison_barb_length (Float or Integer) - Default=4. Length of the wind barb for the comparison time.
    
- comparison_barb_width (Float or Integer) - Default=0.5. Width of the wind barb for the comparison time.
    
- comparison_barb_color (String) - Default='indigo'. Color of the wind barb for the comparison time.
    
- comparison_barb_zorder (Integer) - Default=7. The z-order of the barbs on the image. Lower numbers send this to the back
        higher numbers bring this forward.
        
- barb_legend_x_position (Float or Integer) - Default=0.825. x-position of wind barb legend with respect to the figure axis.
    
- barb_legend_y_position (Float or Integer) - Default=0. y-position of wind barb legend with respect to the figure axis.
    
- barb_legend_fontsize (Integer) - Default=7. Font size of wind barb legend. 
    
- barb_legend_zorder (Integer) - Default=10. The z-order of the borders on the image. Lower numbers send this to the back
        higher numbers bring this forward. 
...
- temperature_pixel_query_value_fontcolor (String) - Default='darkred'. The font color of the temperature pixel query values.

- dew_point_pixel_query_value_fontcolor (String) - Default='darkred'. The font color of the dew point pixel query values.

- relative_humidity_pixel_query_value_fontcolor (String) - Default='darkred'. The font color of the relative humidity pixel query values.

- dew_point_depression_pixel_query_value_fontcolor (String) - Default='darkred'. The font color of the dew point depression pixel query values.
    
- wind_speed_pixel_query_value_fontcolor (String) - Default='purple'. The font color of the wind speed pixel query values.

- wind_gust_pixel_query_value_fontcolor (String) - Default='purple'. The font color of the wind gust pixel query values.
...
def plot_temperature(region='conus',
                     ...
                     filename='RTMA Temperature Comparison.png',
                     proxies=None,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for temperature.
    ...
    An image of the RTMA Temperature Comparison Analysis specified to the user's needs saved to {path}    
    """    
    ...
    if ds1 is None and ds2 is None:
        ds1, ds2 = _rtma_comparison(proxies=proxies,
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("temperature change", colors)
    else:
        cmap = colormap
    ...
    cs = ax.contourf(ds1[longitude_key],
                ds1[latitude_key],
                (ds1[var_key] - ds2[var_key]),
                cmap=cmap,
                levels=levels,
                transform=datacrs,
    ...
    vals1 = _fix_var_array(ds1,
                    var_key,
                    0,
                    decimate)
    
    vals2 = _fix_var_array(ds2,
                    var_key,
                    0,
                    decimate)

    stn = _mpplots.StationPlot(ax, vals1['longitude'], vals1['latitude'],
                                transform=datacrs, 
...
def plot_dew_point(region='conus',
                     ...
                     filename='RTMA Dew Point Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for dew point.
    ...
    An image of the RTMA Dew Point Comparison Analysis specified to the user's needs saved to {path}    
    """    
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("dew point change", colors)
    else:
        cmap = colormap
...
def plot_dew_point_depression(region='conus',
                     ...
                     filename='RTMA Dew Point Depression Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for dew point depression.
    ...
    An image of the RTMA Dew Point Depression Comparison Analysis specified to the user's needs saved to {path}    
    """    
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("dew point depression change", colors)
    else:
        cmap = colormap
...
def plot_relative_humidity(region='conus',
                     ...
                     filename='RTMA Relative Humidity Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for relative humidity.
    ...
    An image of the RTMA Relative Humidity Comparison Analysis specified to the user's needs saved to {path}    
    """    
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("relative humidity change", colors)
    else:
        cmap = colormap
...
def plot_wind_speed(region='conus',
                     ...
                     filename='RTMA Wind Speed Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for sustained wind speed.
    ...
    An image of the RTMA Wind Speed Comparison Analysis specified to the user's needs saved to {path}    
    """
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("wind speed change", colors)
    else:
        cmap = colormap
    ...
    u_vals1 = _fix_var_array(ds1,
                    u_var_key,
                    0,
                    decimate)
    
    v_vals1 = _fix_var_array(ds1,
                    v_var_key,
                    0,
                    decimate)
    
    u_vals2 = _fix_var_array(ds2,
                    u_var_key,
                    0,
                    decimate)
    
    v_vals2 = _fix_var_array(ds2,
                    v_var_key,
                    0,
                    decimate)
    ...
    if pixel_query_type != 'barbs':
        ...
        stn1 = _mpplots.StationPlot(ax, vals1['longitude'], vals1['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
        
        stn2 = _mpplots.StationPlot(ax, vals2['longitude'], vals2['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
        
        stn1.plot_barb(u_vals1[u_var_key], 
                        v_vals1[v_var_key],
        ...
        stn2.plot_barb(u_vals2[u_var_key], 
                        v_vals2[v_var_key],
...
def plot_wind_gust(region='conus',
                     ...
                     filename='RTMA Wind Gust Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    """
    This function plots the latest Real Time Mesoscale Analysis (RTMA) Comparison for wind gust.
    ...
    An image of the RTMA Wind Gust Comparison Analysis specified to the user's needs saved to {path}    
    """
    ...
    if colormap == 'custom':
        cmap = _mcolors.LinearSegmentedColormap.from_list("wind gust change", colors)
    else:
        cmap = colormap
...
def plot_temperature_and_wind(region='conus',
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER TEMPERATURE (SHADED) [Δ°F] & 10-METER WIND [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
                     ...
                     wind_speed_pixel_query_value_fontcolor='purple',
                     pixel_query_stroke_linewidth=1,
                     path='FireWxPy Graphics/RTMA Comparison/Temperature',
                     filename='RTMA Comparison Temperature and Wind Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    An image of the RTMA Comparison Temperature + Wind Analysis specified to the user's needs saved to {path}    
    """
    ...
    cs = ax.contourf(ds1[longitude_key],
                ds1[latitude_key],
                (ds1[temperature_var_key] - ds2[temperature_var_key]),
                cmap=cmap,
                levels=levels,
                transform=datacrs,
                alpha=contourf_alpha,
    ...
    ws_vals1 = _fix_var_array(ds1,
                    wind_speed_var_key,
                    0,
                    decimate)
    
    temp_vals2 = _fix_var_array(ds2,
                    temperature_var_key,
                    0,
                    decimate)
    ...
    ws_vals2 = _fix_var_array(ds2,
                    wind_speed_var_key,
                    0,
                    decimate)

    stn1 = _mpplots.StationPlot(ax, temp_vals1['longitude'], temp_vals1['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
    
    stn2 = _mpplots.StationPlot(ax, temp_vals2['longitude'], temp_vals2['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
    ...
    stn1.plot_parameter(temp_value_loc.upper(), 
                       (temp_vals1[temperature_var_key] - temp_vals2[temperature_var_key]), 
    ...
    stn1.plot_parameter(speed_value_loc.upper(), 
                       (ws_vals1[wind_speed_var_key] - ws_vals2[wind_speed_var_key]), 
...
def plot_temperature_and_gust(region='conus',
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER TEMPERATURE (SHADED) [Δ°F] & 10-METER GUST [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
                     ...
                     pixel_query_stroke_linewidth=1,
                     path='FireWxPy Graphics/RTMA Comparison/Temperature',
                     filename='RTMA Comparison Temperature and Gust Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    stn1.plot_parameter(gust_value_loc.upper(), 
                       (wg_vals1[wind_gust_var_key] - wg_vals2[wind_gust_var_key]), 
                       color= wind_speed_pixel_query_value_fontcolor, 
                       path_effects=[_withStroke(linewidth=pixel_query_stroke_linewidth, 
                                                 foreground=pixel_query_value_foreground)], 
                       zorder=pixel_query_value_zorder)
...
def plot_relative_humidity_and_wind(region='conus',
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER RELATIVE HUMIDITY (SHADED) [Δ%] & 10-METER WIND [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
                     ...
                     pixel_query_stroke_linewidth=1,
                     path='FireWxPy Graphics/RTMA Comparison/Relative Humidity',
                     filename='RTMA Comparison Relative Humidity and Wind Comparison.png',
                     proxies=None,
                     clear_recycle_bin=False,
                     clear_data=True,
                     chunk_size=8192,
    ...
    cs = ax.contourf(ds1[longitude_key],
                ds1[latitude_key],
                (ds1[relative_humidity_var_key] - ds2[relative_humidity_var_key]),
                cmap=cmap,
                levels=levels,
                transform=datacrs,
                alpha=contourf_alpha,
    ...
    stn1 = _mpplots.StationPlot(ax, rh_vals1['longitude'], rh_vals1['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
    
    stn2 = _mpplots.StationPlot(ax, rh_vals2['longitude'], rh_vals2['latitude'],
                                transform=datacrs, 
                                fontsize=pixel_query_value_fontsize, 
                                zorder=pixel_query_value_zorder, 
                                clip_on=True)
    ...
    stn1.plot_parameter(rh_value_loc.upper(), 
                       (rh_vals1[relative_humidity_var_key] - rh_vals2[relative_humidity_var_key]), 
...
def plot_relative_humidity_and_gust(region='conus',
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER RELATIVE HUMIDITY (SHADED) [Δ%] & 10-METER GUST [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
...
def plot_dew_point_depression_and_wind(region='conus',
                     show_states=True,
                     state_border_color='black',
                     state_border_linewidth=0.5,
                     state_border_zorder=3,
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER DEW POINT DEPRESSION (SHADED) [Δ°F] & 10-METER WIND [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
                     ...
                     mapcrs=_ccrs.PlateCarree(),
                     datacrs=_ccrs.PlateCarree(),
                     dew_point_depression_var_key='2m_dew_point_depression',
                     wind_speed_var_key='10m_wind_speed',
                     u_var_key='10m_u_wind_component',
                     v_var_key='10m_v_wind_component',
                     time_coord_key='time',
    ...
    cs = ax.contourf(ds1[longitude_key],
                ds1[latitude_key],
                (ds1[dew_point_depression_var_key] - ds2[dew_point_depression_var_key]),
                cmap=cmap,
                levels=levels,
                transform=datacrs,
                alpha=contourf_alpha,
...
def plot_dew_point_depression_and_gust(region='conus',
                     show_states=True,
                     state_border_color='black',
                     state_border_linewidth=0.5,
                     state_border_zorder=3,
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER DEW POINT DEPRESSION (SHADED) [Δ°F] & 10-METER GUST [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
...
def plot_dew_point_and_wind(region='conus',
                     show_states=True,
                     state_border_color='black',
                     state_border_linewidth=0.5,
                     state_border_zorder=3,
                     ...
                     step=1,
                     facecolor='aliceblue',
                     primary_title_text='RTMA COMPARISON: 2-METER DEW POINT (SHADED) [Δ°F] & 10-METER WIND [ΔMPH]',
                     primary_title_textbox_color='wheat',
                     primary_title_textbox_style='round',
                     primary_title_textbox_alpha=1,
                     secondary_title_textbox_color='wheat',
    ...
    cs = ax.contourf(ds1[longitude_key],
                ds1[latitude_key],
                (ds1[dew_point_var_key] - ds2[dew_point_var_key]),
                cmap=cmap,
                levels=levels,
                transform=datacrs,
                alpha=contourf_alpha,
...
def plot_dew_point_and_gust(region='conus',
                     show_states=True,
                     state_border_color='black',
                     state_border_linewidth=0.5,
                     state_border_zorder=3,
