'''
This is a sample program of how to create all the fire weather graphics surrounding maximum and minimum relative humidity from the National Weather Service NDFD gridded forecast data. 
