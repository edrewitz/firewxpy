...
##### Dry And Gusty Forecast

This function plots the latest available NOAA/NWS Dry and Windy Forecast. [Source Code](https://github.com/edrewitz/firewxpy/blob/main/firewxpy/NWS_Forecast_Graphics.py#L15252)
