...
class relative_humidity:
    ...
    def plot_minimum_relative_humidity_forecast(low_rh_threshold=15, high_rh_threshold=60, western_bound=None, eastern_bound=None, southern_bound=None, northern_bound=None, shrink=0.7, show_rivers=True, reference_system='States & Counties', show_state_borders=False, show_county_borders=False, show_gacc_borders=False, show_psa_borders=False, show_cwa_borders=False, show_nws_firewx_zones=False, show_nws_public_zones=False, state_border_linewidth=1, county_border_linewidth=0.25, gacc_border_linewidth=1, psa_border_linewidth=1, cwa_border_linewidth=1, nws_firewx_zones_linewidth=0.5, nws_public_zones_linewidth=0.5, state_border_linestyle='-', county_border_linestyle='-', gacc_border_linestyle='-', psa_border_linestyle='-', cwa_border_linestyle='-', nws_firewx_zones_linestyle='-', nws_public_zones_linestyle='-', data=False, ds_short=None, ds_extended=None, decimate='default', state='conus', gacc_region=None, x1=0.01, y1=-0.03, x2=0.725, y2=-0.025, x3=0.01, y3=0.01, cwa=None, signature_fontsize=6, stamp_fontsize=5, x=0.01, y=0.97):
        ...
        for i in range(start, short_stop, 1):
            ...
            c_low = ax.contour(ds_short['longitude'][:, :], ds_short['latitude'][:, :], mpcalc.smooth_gaussian(ds_short['unknown'][i, :, :], n=8), levels=[low_rh_threshold], colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
            ax.clabel(c_low, levels=[low_rh_threshold], inline=True, fontsize=8, rightside_up=True)  

            c_high = ax.contour(ds_short['longitude'][:, :], ds_short['latitude'][:, :], mpcalc.smooth_gaussian(ds_short['unknown'][i, :, :], n=8), levels=[high_rh_threshold], colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
        ...
        for i in range(0, extended_stop, 1):
            ...
            c_low = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian(ds_extended['unknown'][i, :, :], n=8), levels=[low_rh_threshold], colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
            ax.clabel(c_low, levels=[low_rh_threshold], inline=True, fontsize=8, rightside_up=True)  

            c_high = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian(ds_extended['unknown'][i, :, :], n=8), levels=[high_rh_threshold], colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
            ax.clabel(c_high, levels=[high_rh_threshold], inline=True, fontsize=8, rightside_up=True)    
        ...
        for i in range(1, extended_stop, 1):
            ...
            if i == 1:
                try:
                    ...
                    cs = ax.contourf(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], (ds_extended['maxrh'][i-1, :, :] - ds_short['maxrh'][short_stop - 1, :, :]), levels=levels, cmap=cmap, transform=datacrs, alpha=0.5, extend='both')
                    cbar = fig.colorbar(cs, shrink=shrink, pad=0.01, location='right', ticks=labels)
        
                    c_low = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['maxrh'][i-1, :, :] - ds_short['maxrh'][short_stop - 1, :, :]), n=8), levels=lower, colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_low, levels=lower, inline=True, fontsize=8, rightside_up=True)  
        
                    c_high = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['maxrh'][i-1, :, :] - ds_short['maxrh'][short_stop - 1, :, :]), n=8), levels=higher, colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_high, levels=higher, inline=True, fontsize=8, rightside_up=True) 
                except Exception as e:
                    pass
        ...
        for i in range(1, short_stop, 1):
            ...
            if show_nws_public_zones == True:
                ...
                try:
                    ...
                    c_low = ax.contour(ds_short['longitude'][:, :], ds_short['latitude'][:, :], mpcalc.smooth_gaussian((ds_short['unknown'][i, :, :] - ds_short['unknown'][i-1, :, :]), n=8), levels=lower, colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_low, levels=lower, inline=True, fontsize=8, rightside_up=True)  
        
                    c_high = ax.contour(ds_short['longitude'][:, :], ds_short['latitude'][:, :], mpcalc.smooth_gaussian((ds_short['unknown'][i, :, :] - ds_short['unknown'][i-1, :, :]), n=8), levels=higher, colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_high, levels=higher, inline=True, fontsize=8, rightside_up=True)   
                except Exception as e:
                    pass
        ...
        for i in range(1, extended_stop, 1):
            ...
            if i == 1:
                try:
                    ...
                    cs = ax.contourf(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], (ds_extended['unknown'][i-1, :, :] - ds_short['unknown'][short_stop - 1, :, :]), levels=levels, cmap=cmap, transform=datacrs, alpha=0.5, extend='both')
                    cbar = fig.colorbar(cs, shrink=shrink, pad=0.01, location='right', ticks=labels)
        
                    c_low = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['unknown'][i-1, :, :] - ds_short['unknown'][short_stop - 1, :, :]), n=8), levels=lower, colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_low, levels=lower, inline=True, fontsize=8, rightside_up=True)  
        
                    c_high = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['unknown'][i-1, :, :] - ds_short['unknown'][short_stop - 1, :, :]), n=8), levels=higher, colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_high, levels=higher, inline=True, fontsize=8, rightside_up=True) 
                except Exception as e:
                    pass
                ...
                try:
                    ...
                    c_low = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['unknown'][i-1, :, :] - ds_extended['unknown'][i-2, :, :]), n=8), levels=lower, colors='darkred', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_low, levels=lower, inline=True, fontsize=8, rightside_up=True)  
        
                    c_high = ax.contour(ds_extended['longitude'][:, :], ds_extended['latitude'][:, :], mpcalc.smooth_gaussian((ds_extended['unknown'][i-1, :, :] - ds_extended['unknown'][i-2, :, :]), n=8), levels=higher, colors='darkblue', zorder=2, transform=datacrs, linewidths=1, linestyles='--')
                    ax.clabel(c_high, levels=higher, inline=True, fontsize=8, rightside_up=True)    
                except Exception as e:
                    pass
